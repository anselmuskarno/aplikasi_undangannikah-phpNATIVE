              ...
              <div class="col-md-12 col-sm-12 ">
                ...
                <form method="POST" action="updateResepsi.php" class="form-horizontal form-label-left" enctype="multipart/form-data">
                  ...
                  ?>
                    ...
                    <input type="text" name="audioLama" value="<?php echo $tampilResepsi['audio']; ?>" hidden>
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align">Anak Ke ... (Mempelai Pria) </label>
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" required class="form-control" name="anakpria_ke" value="<?php echo $tampilResepsi['anakpria_ke']; ?>">
                      </div>
                    </div>
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align">Nama Ayah (Mempelai Pria)</label>
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" required class="form-control" name="nama_ayah_pria" value="<?php echo $tampilResepsi['nama_ayah_pria']; ?>">
                      </div>
                    </div>
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align">Nama Ibu (Mempelai Pria)</label>
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" required class="form-control" name="nama_ibu_pria" value="<?php echo $tampilResepsi['nama_ibu_pria']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align">Anak Ke ... (Mempelai Wanita) </label>
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" required class="form-control" name="anakwanita_ke" value="<?php echo $tampilResepsi['anakwanita_ke']; ?>">
                      </div>
                    </div>
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align">Nama Ayah (Mempelai Wanita)</label>
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" required class="form-control" name="nama_ayah_wanita" value="<?php echo $tampilResepsi['nama_ayah_wanita']; ?>">
                      </div>
                    </div>
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align">Nama Ibu (Mempelai Wanita)</label>
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" required class="form-control" name="nama_ibu_wanita" value="<?php echo $tampilResepsi['nama_ibu_wanita']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align">Upload Audio</label>
                      <div class="col-md-6 col-sm-6 ">
                        <input type="file" name="audio">
                        <label>Format File Audio Yang Direkomendasikan adalah mp3</label>
                      </div>
                    </div>
