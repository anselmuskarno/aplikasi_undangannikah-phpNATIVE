...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Agu 2023 pada 15.00
...
(4, 'coba', 'Dan pada akhirnya kaulah yang menjadi putri di hatiku dan pada hari ini aku akan menikah denganmu', 'pesona-citra-kirana-dan-rezky-aditya-di-akad-nikah-cerah-nan-elegan-3VfbMf4ata.jpg');
...
CREATE TABLE `resepsi` (
  ...
  `audio` text NOT NULL,
  `anakpria_ke` varchar(255) NOT NULL,
  `nama_ayah_pria` varchar(255) NOT NULL,
  `nama_ibu_pria` varchar(255) NOT NULL,
  `anakwanita_ke` varchar(255) NOT NULL,
  `nama_ayah_wanita` varchar(255) NOT NULL,
  `nama_ibu_wanita` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `resepsi` (`idResepsi`, `namaPria`, `namaWanita`, `tglResepsi`, `jamResepsi`, `alamatResepsi`, `namaGedung`, `fileGambar`, `gambarGedung`, `audio`, `anakpria_ke`, `nama_ayah_pria`, `nama_ibu_pria`, `anakwanita_ke`, `nama_ayah_wanita`, `nama_ibu_wanita`) VALUES
(1, 'Raffi', 'Nagita', '2023-10-31', '08:03:22', 'Jl. Poros Makale Rantepao                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ', '682906642.jpg', 'img_0140-1588044288.jpg', '682906642.jpg', 'y2mate.com - Andmesh  Sampai Tua Nanti Official Music Video.mp3', '3', 'coba', 'lagi', '2', 'nice', 'people');
...
INSERT INTO `undangan` (`id`, `nama_tamu`, `nomor_hp`) VALUES
(4, 'Peny', '6282262351565'),
(5, 'Yeheskiel R., S.Th.', '6281356304157'),
(7, 'Adol', '6282210276716');
...
--
ALTER TABLE `galery`
  MODIFY `idGalery` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
