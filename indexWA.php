...
<body>
	...
	<header>
		<div class="container">
			...
			<ul class="main-menu visible-on-click" id="main-menu">
				<li class="active"><a href="indexWA.php">BERANDA</a></li>
			</ul>
		</div>
	</header>
	<!-- end = menu -->
	...
	?>
		<input type="hidden" id="audioku" value="<?php echo "Admin/fileUpload/" . $infoResepsi['audio']; ?>">
			...
			<div class="display-table center-text">
				<div class="display-table-cell">
					<div class="slider-content">
						...
						<div class="d-flex mt-2" style="margin-left: 400px;">
							<span>Anak ke <?php echo $infoResepsi['anakpria_ke']; ?> dari keluarga <br> <?php echo $infoResepsi['nama_ayah_pria']; ?> dan <?php echo $infoResepsi['nama_ibu_pria']; ?></span>
							<div style="width: 100px;"></div>
							<span>Anak ke <?php echo $infoResepsi['anakwanita_ke']; ?> dari keluarga <br> <?php echo $infoResepsi['nama_ayah_wanita']; ?> dan <?php echo $infoResepsi['nama_ibu_wanita']; ?></span>
						</div>
						<p class="mt-5 text-white">Kepada Yth.</p>
						<p class="text-white">Bapak/Ibu/Saudara/i</p>
						<h3 class="text-white"> <?= $_GET["nama"] ?> </h3>
						<p class="text-white">Di Tempat</p>
						<!-- <p class="text-white">Bapak/Ibu/Saudara/i</p> -->
					<?php
				}
					?>

					<a onclick="return enableScroll()" id="coba" class="btn mt-5">Buka Undangan</a>
			...
			<div class="contact-wrapper section float-left">
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-10">
							<div class="heading">
								<h3 class="title">Amplop Digital</h3>
								<i class="icon icon-star"></i>
							</div>

							<div class="margin-bottom">
								<p>Nomor Rekening</p>
								<h3>0232010754533 an. Peni</h3>
							</div>
						</div>
					</div>
				</div>
		...
		<footer>
			<div class="container center-text" id="sosmed">
				...
				<p class="copyright"> Copyright &copy;<script>
					...
					- Dibuat <i class="icon-heart" aria-hidden="true"></i> di Toraja</p>
			</div>
		</footer>
		<!-- end = footer -->
		...
		<script>
			// alert(document.getElementById('audioku').value);
			let beat = new Audio(document.getElementById('audioku').value);
			beat.play();
		</script>
		...
		<script>
			...
			let undangan = document.getElementById('coba');


			function enableScroll() {
				undangan.innerHTML = "Anda telah membuka undangan ini";
				undangan.style.backgroundColor = "white";
				undangan.style.color = "lightpink";
				window.onscroll = function() {};
			}
		</script>
